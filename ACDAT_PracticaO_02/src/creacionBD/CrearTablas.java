...
public class CrearTablas {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            sentencia.execute(creaModulo);
            System.out.println("Tabla 'Modulo' creada correctamente");
            sentencia.execute(creaProfesor);
            System.out.println("Tabla 'Profesor' creada correctamente");
            sentencia.execute(creaAlumno);
            System.out.println("Tabla 'Alumno' creada correctamente");
            sentencia.execute(creaDatos_Alumno);
            System.out.println("Tabla 'Datos_Alumno' creada correctamente");
